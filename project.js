...
export class FinalProject extends Scene {
    constructor() {
        ...
        // *** Materials
        this.materials = {
            test: new Material(new defs.Phong_Shader(), {ambient: .4, diffusivity: .6, color: hex_color("#ffffff")}),
            test2: new Material(new Gouraud_Shader(), {ambient: .4, diffusivity: .6, color: hex_color("#992828")}),
            test3: new Material(new defs.Phong_Shader(), {ambient: 1, diffusivity: .6, color: hex_color("#ff8e31")}),
            test4: new Material(new defs.Phong_Shader(), {ambient: 0, diffusivity: 1, color: color(0.5, 0.5, 0.5, 1)}),
        }
    ...
    display(context, program_state) {
        ...
        program_state.lights = [new Light(light_position, sun_color, 10**5)];
